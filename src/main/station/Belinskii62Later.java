...
public class Belinskii62Later {
    ...
    private static Pattern pattern62 = Pattern.compile("(?<=(62\\s.{26}\\s\\d{2}:\\d{2}))(.+)");
    ...
    public static String getBelinskii62Later() throws Exception {
