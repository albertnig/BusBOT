...
public class Naberezhnaya45Later {
    ...
    private static Pattern pattern45 = Pattern.compile("(?<=(45\\s.{20}\\s\\d{2}:\\d{2}))(.+)");
    ...
    private static Pattern pattern45Later = Pattern.compile("45\\s\\D+\\d\\s\\d{2}:\\d{2}");
    ...
    public static String getNaberezhnaya45Later() throws Exception {
