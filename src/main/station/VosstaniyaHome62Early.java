...
public class VosstaniyaHome62Early {
    ...
    private static Pattern pattern62 = Pattern.compile("62\\s\\D+\\s\\d{2}:\\d{2}");
    ...
    public static String getVosstaniyaHome62() throws Exception {
        ...
        String bus621 = getDateFromStringNumber(bus62);
        String bus622 = getDateFromStringTime(bus62);
