...
public class VosstaniyaJob45Early {
    ...
    private static Pattern pattern45 = Pattern.compile("45\\s\\D+\\s\\d{2}:\\d{2}");
    ...
    public static String getVosstaniyaJob45() throws Exception {
